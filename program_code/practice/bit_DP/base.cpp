...
int main() {
    ...
    // cout << "{1, 3, 5} = " << bitset<8>(1) << endl;
    // cout << "{1, 3, 5} = " << bitset<8>(6) << endl;

    // cout << "{1, 3, 5} = " << bitset<8>(2) << endl;
    // cout << "{1, 3, 5} = " << bitset<8>(7) << endl;

    // cout << "{1, 3, 5} = " << bitset<8>(3) << endl;
    // cout << "{1, 3, 5} = " << bitset<8>(4) << endl;

    cout << "{1, 3, 5} = " << bitset<8>(1 | 6) << endl;
    cout << "{1, 3, 5} = " << bitset<8>(2 | 7) << endl;
    cout << "{1, 3, 5} = " << bitset<8>(3 | 4) << endl;
